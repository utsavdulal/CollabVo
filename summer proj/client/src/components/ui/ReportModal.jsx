      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        <div className="flex items-center justify-between border-b border-zinc-100 pb-3">
          <div className="flex items-center gap-2 text-red-600">
            ...
            <h2 className="text-sm font-bold text-zinc-900">Report User or Campaign</h2>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        {submitted ? (
          <div className="py-6 text-center">
            ...
            <h3 className="text-sm font-bold text-zinc-900">Report Submitted</h3>
          ...
          <form onSubmit={submit} className="mt-4 space-y-3.5">
            <p className="text-xs text-zinc-600">
              Reporting: <strong className="text-zinc-900">{targetUser?.name || 'User'}</strong>
            </p>
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-zinc-700">Details (optional)</label>
              <textarea
                value={details}
